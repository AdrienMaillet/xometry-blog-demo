...
// Function to retrieve the firs timage the post's text
const firstImage = (image => {
  let firstImageSlice = image.body.find(slice => slice.type === 'image_with_caption');
  if (firstImageSlice != null) {
   // return console.log("image", firstImageSlice.primary.image.url)
   return (
    <picture>
      <img src={firstImageSlice.primary.image.url } alt={""} />
    </picture>
   );
  } else {
    return null;
